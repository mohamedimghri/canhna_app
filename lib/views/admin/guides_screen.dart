...
class _GuidesScreenState extends State<GuidesScreen> {
  ...
  Future<void> _fetchGuides() async {
    ...
    try {
      ...
      setState(() {
        _guides = data.map((json) => Profile.fromJson(json)).toList();
      });
    } catch (e) {
                  ...
                  child: Row(
                    children: [
                      CircleAvatar(
                        ...
                        backgroundImage: guide.imageUrl != null && guide.imageUrl!.isNotEmpty
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: Container(
                            ...
                            height: 20,
                            decoration: BoxDecoration(
                              color: (guide.isActive ?? false) ? Colors.green : Colors.red,
                    ...
                    _buildDetailRow(
                      ...
                      label: 'Status',
                      value: (guide.isActive ?? false) ? 'Active' : 'Inactive',
                      valueColor: (guide.isActive ?? false) ? Colors.green : Colors.red,
                    ),
