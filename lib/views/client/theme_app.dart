...
/// A class that contains all theme configurations for the sports application.
class AppTheme {
  AppTheme._();

  // Sports application color palette based on design specifications
  ...
  static const Color borderLight = Color(0xFFE0E0E0); // Subtle gray borders
  ...
  // Dark theme colors - adapted for sports application
  ...
  static const Color secondaryVariantDark = Color(0xFF388E3C); // Darker green
  ...
  static const Color cardDark = Color(0xFF2D2D2D); // Card background dark
  ...
  static const Color borderDark = Color(0xFF424242); // Dark borders
  ...
  /// Light theme optimized for sports application
  static ThemeData lightTheme = ThemeData(
    ...
    // AppBar theme for sports application headers
    ...
    // Card theme with subtle elevation for match cards
    cardTheme: CardTheme(
      color: cardLight,
      elevation: 2.0,
      shadowColor: shadowLight,
    ...
    // Bottom navigation for sports app navigation
    ...
    // FAB for contextual actions like ticket purchases
    ...
    // Button themes for sports application actions
  ...
  /// Dark theme optimized for sports application
